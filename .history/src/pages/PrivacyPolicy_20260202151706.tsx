...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F3]">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-[#8B4513] via-[#A0522D] to-[#D2691E] text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#8B4513] to-[#D2691E] rounded-xl flex items-center justify-center">
              ...
              <ul className="space-y-3">
                {section.content.map((item, i) => (
                  <motion.li
                    ...
                    style={{ fontFamily: "'DM Sans', sans-serif" }}
                  >
                    <span className="flex-shrink-0 w-2 h-2 bg-[#D2691E] rounded-full mt-2" />
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#8B4513] to-[#D2691E] text-white rounded-2xl p-8 shadow-xl"
        >
          <h2
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="tel:+255XXXXXXXXX" className="hover:underline">
                +255 XXX XXX XXX
              </a>
            </div>
          </div>
        ...
        >
          <Link to="/">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#8B4513] text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              ← Back to Home
            </motion.button>
