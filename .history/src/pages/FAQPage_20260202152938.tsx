...
const FAQPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F3]">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-[#8B4513] via-[#A0522D] to-[#D2691E] text-white overflow-hidden py-20">
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl text-[#2C2C2C] bg-white shadow-xl focus:outline-none focus:ring-4 focus:ring-white/20 transition-all"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              />
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
                  ...
                  <motion.button
                    ...
                    className={`w-full flex items-center justify-between p-3 rounded-xl transition-all ${
                      selectedCategory === category.id
                        ? "bg-gradient-to-r from-[#8B4513] to-[#D2691E] text-white shadow-lg"
                        : "bg-[#F8F6F3] text-[#666] hover:bg-[#E8E6E3]"
                    }`}
                    style={{ fontFamily: "'DM Sans', sans-serif" }}
                  >
            ...
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="bg-gradient-to-br from-[#8B4513] to-[#D2691E] rounded-2xl p-6 text-white shadow-xl"
            >
            ...
            <motion.div
              ...
              className="relative bg-gradient-to-br from-[#2C2C2C] to-[#1A1A1A] rounded-2xl p-6 text-white shadow-xl overflow-hidden"
            >
              <motion.div
                animate={{
                  scale: [1, 1.2, 1],
                ...
                className="absolute -top-10 -right-10 w-32 h-32 bg-[#D2691E] opacity-20 rounded-full blur-3xl"
              />
              <div className="relative">
                <div className="flex items-center gap-2 mb-3">
                  <Sparkles className="w-6 h-6 text-[#D2691E]" />
                ...
                <Link to="/quote">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-full bg-gradient-to-r from-[#D2691E] to-[#8B4513] text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2"
                  >
                    Claim Offer
            ...
            >
              <div className="flex items-center gap-1 mb-3">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-[#D2691E] text-[#D2691E]" />
                ))}
              </div>
              <p
                className="text-[#666] italic mb-4 leading-relaxed"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                "Exceptional craftsmanship! The dining table we ordered exceeded our
                expectations. The team was professional and delivered on time."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gradient-to-br from-[#8B4513] to-[#D2691E] rounded-full flex items-center justify-center text-white font-bold">
                  AM
                </div>
                <div>
                  <div className="font-semibold text-[#2C2C2C]">Amina Mohammed</div>
                  <div className="text-sm text-[#999]">Dar es Salaam</div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-3">
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="w-full flex items-center justify-center gap-2 bg-[#25D366] text-white py-3 rounded-xl font-semibold shadow-lg"
                  >
                    <MessageCircle className="w-5 h-5" />
                    Chat on WhatsApp
                  </motion.button>
                </a>
                <a href="tel:+255XXXXXXXXX">
                  <motion.button
                    whileHover={{ scale: 1.03 }}
                    whileTap={{ scale: 0.97 }}
                    className="w-full flex items-center justify-center gap-2 bg-[#8B4513] text-white py-3 rounded-xl font-semibold shadow-lg"
                  >
                ...
                <Link to="/contact">
                  <motion.button
                    whileHover={{ scale: 1.03 }}
                    whileTap={{ scale: 0.97 }}
                    className="w-full flex items-center justify-center gap-2 border-2 border-[#8B4513] text-[#8B4513] py-3 rounded-xl font-semibold"
                  >
          ...
          <div className="flex-1">
            ...
            {filteredFAQs.length === 0 ? (
              ...
              >
                <Search className="w-16 h-16 text-[#D2691E] mx-auto mb-4" />
                <h3
                ...
                <p className="text-[#666]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <ChevronDown
                          className={`w-6 h-6 ${
                            openFAQ === index ? "text-[#8B4513]" : "text-[#999]"
                          }`}
                        />
                      </motion.div>
                    </motion.button>
                      ...
                      {openFAQ === index && (
                        ...
                        >
                          <div className="px-6 pb-6">
                            <div className="h-px bg-gradient-to-r from-[#8B4513] to-transparent mb-4" />
                            <p
      ...
      >
        <div className="bg-gradient-to-br from-[#8B4513] via-[#A0522D] to-[#D2691E] rounded-3xl p-12 text-center text-white relative overflow-hidden shadow-2xl">
          <motion.div
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3],
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/quote">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-white text-[#8B4513] rounded-xl font-bold shadow-xl"
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  Request a Quote
                </motion.button>
              ...
              <Link to="/products">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-white/10 backdrop-blur-lg border-2 border-white text-white rounded-xl font-bold"
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  Browse Products
                </motion.button>
