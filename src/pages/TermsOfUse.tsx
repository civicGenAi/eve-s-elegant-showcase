...
const TermsOfUse = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F3]">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-[#070809] via-[#5D6F70] to-[#070809] text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg border-l-4 border-[#A87749]">
            <div className="flex items-start gap-4">
              <AlertCircle className="w-6 h-6 text-[#A87749] flex-shrink-0 mt-1" />
              <div>
                <h3
                  className="text-xl font-bold text-[#070809] mb-3"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Important Notice
                </h3>
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#070809] to-[#5D6F70] rounded-xl flex items-center justify-center">
              ...
              <ul className="space-y-3">
                {section.content.map((item, i) => (
                  <motion.li
                    ...
                    style={{ fontFamily: "'DM Sans', sans-serif" }}
                  >
                    <span className="flex-shrink-0 w-1.5 h-1.5 bg-[#070809] rounded-full mt-2" />
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div className="space-y-3 text-[#5D6F70]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#070809] to-[#5D6F70] text-white rounded-2xl p-8 shadow-xl"
        >
          <h2
        ...
        >
          <Link to="/">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-[#A87749] text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              ← Back to Home
            </motion.button>
          ...
          <Link to="/privacy-policy">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-white text-[#070809] border-2 border-[#070809] rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              View Privacy Policy →
            </motion.button>
